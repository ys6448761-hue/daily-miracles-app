'use strict';
// [deprecated] → node scripts/thumbnail/build-thumbnail.js --location cablecar
console.warn('⚠️  [deprecated] use: node scripts/thumbnail/build-thumbnail.js --location cablecar');
...
copies.forEach((rawCopy, i) => {
  ...
  const prompt =
`DreamTown cablecar thumbnail illustration.
...
Color:
Cablecar: ${ssot.color.cablecar}
Background: ${ssot.color.background}
...
Character:
Sowoni looking outside, emotional state: moving, searching.
