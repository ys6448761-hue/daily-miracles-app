...
| RESEARCH-018 (Candidate Promotion Criteria) | Draft | `docs/constitution/research/RESEARCH-018_Candidate_Promotion_Criteria.md` — Evidence → Candidate 제안 기준 (Non-Criteria 포함), RESEARCH-016/017의 다음 단계 |
| RESEARCH-019 (Raw Interview Collection Protocol) | Draft | `docs/constitution/research/RESEARCH-019_Raw_Interview_Collection_Protocol.md` — 인터뷰 수집 원칙/메타데이터/품질 체크리스트. RESEARCH-011과 상당 부분 중복 확인됨(문서 내 명시, 통합 여부 미정) |
