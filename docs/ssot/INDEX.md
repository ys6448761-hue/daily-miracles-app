...
| `SSOT-METRIC-001_Loop_Measurement_Framework.md` | **핵심 측정 체계** — 북극성 지표(재방문 해제율)·KPI 7개·건강 지표·허영 지표 구분·제품 판단 기준 | **기능 개발·마케팅·제휴·콘텐츠 판단 전** |
...
| v5.6 | 2026-06-10 | SSOT-METRIC-001 — 루프 측정 체계 확정 (북극성: 재방문 해제율) |
