...
### NextAuth/웹
- NEXTAUTH_URL: (예: https://plaza.dailymiracles.kr)
- NEXTAUTH_SECRET: (랜덤 시크릿) ← **Code 생성 필요**
- NEXT_PUBLIC_ADMIN_ALLOWLIST: (운영 관리자 닉네임 allowlist) ← **푸르미르 포함**
...
✅ 확인 필요:
- [ ] NEXTAUTH_URL 확정
- [ ] NEXTAUTH_SECRET 생성(안전한 방식) ← Code 실행 필요
