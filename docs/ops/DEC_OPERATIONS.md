...
> INCIDENT-20260302-001 재발 방지 규칙
...
|------|-----------|
| 리뷰/체크 통과 후 머지 | ✅ 허용 |
| `--admin` override 머지 | ❌ 금지 (CEO 명시적 승인 시에만 예외) |
| 브랜치 보호 규칙 우회 자동 실행 | ❌ 금지 |

### 브라우저/환경 장애 시 대응 절차

1. 브라우저 드라이버 오류 등으로 GitHub 웹 접근 불가 시
2. **Antigravity는 CEO에게 확인 요청 후 대기**
3. CEO 승인 확인 시에만 `--admin` 또는 우회 수단 사용
4. 사용 시 반드시 `INCIDENT-YYYYMMDD-###.md` 기록

### 관련 인시던트

- [INCIDENT-20260302-001](./INCIDENT-20260302-001.md) — PR #23 admin override 머지
...
*마지막 업데이트: 2026-03-02 (INCIDENT-20260302-001 재발 방지 규칙 추가)*
