...
// ── Aurora5 wish_text 키워드 매핑 ────────────────────────────────────
// WishSelect 3개 선택지 포함 + 자유 입력 키워드 커버
const AURORA5_WISH_MAP = [
  // WishSelect 선택지 직접 매칭
  { kw: ['닮은', '지금 나와'],
    text: '이 마음은, 이미 당신 안에 있었어요.\n지금, 조금 더 또렷해졌어요.' },
  { kw: ['가고 싶은', '방향', '나아가'],
    text: '이 마음은, 이미 당신 안에 있었어요.\n지금, 조금 더 또렷해졌어요.' },
  { kw: ['움직이게', '움직이는'],
    text: '이 마음은, 이미 당신 안에 있었어요.\n지금, 조금 더 또렷해졌어요.' },
...
// 기본값 — 어떤 wish_text도 매칭되지 않을 때
const AURORA5_DEFAULT = '이 마음은, 이미 당신 안에 있었어요.\n지금, 조금 더 또렷해졌어요.';
